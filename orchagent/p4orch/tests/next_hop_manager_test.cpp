...
const P4NextHopAppDbEntry kP4NextHopAppDbEntry1{
    /*next_hop_id=*/kNextHopId, /*router_interface_id=*/kRouterInterfaceId1,
...
CreateAttributeListForNextHopObject(const P4NextHopAppDbEntry& app_entry,
...
bool NextHopManagerTest::ResolveNextHopEntryDependency(
    const P4NextHopAppDbEntry& app_db_entry, const sai_object_id_t& rif_oid) {
  ...
  const std::string neighbor_key = KeyGenerator::generateNeighborKey(
      app_db_entry.router_interface_id, app_db_entry.neighbor_id);
